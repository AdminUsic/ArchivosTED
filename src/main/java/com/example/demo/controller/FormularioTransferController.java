...
public class FormularioTransferController {
    ...
    @Autowired
    CubiertaService cubiertaService;

    @Autowired
    VolumenService volumenService;
    ...
    @ResponseBody
    public ResponseEntity<String> ModFormTRANSFERENCIAG(@Validated FormularioTransferencia formularioTransferencia,
            Model model) {
